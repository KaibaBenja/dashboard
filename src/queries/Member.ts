...
export const AddMembers = async (data: MemberBodyData) => {
    try {
        const response = await axios.post(`${process.env.NEXT_PUBLIC_BACK_URI}/members`, data);
...
export const fetchMember = async (memberId: string) => {
    try {
        const response = await axios.get(
            `${process.env.NEXT_PUBLIC_BACK_URI}/members/${memberId}`
        );
        return response.data;
    } catch (error) {
...
export const fetchMembers = async () => {
    try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_BACK_URI}/members`);
        return response.data;
    } catch (error) {
...
export const UpdateMembers = async (memberId: string, data: MemberBodyData) => {
    try {
        await axios.put(`${process.env.NEXT_PUBLIC_BACK_URI}/members/${memberId}`, data);
    } catch (error) {
...
export async function deleteMember(memberId: string) {
    try {
        await axios.delete(`${process.env.NEXT_PUBLIC_BACK_URI}/members/${memberId}`);
